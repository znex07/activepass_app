    ...
    <div class="container bg-light text-dark py-3 rounded mt-2" >
        <div class="row justify-content-center" >
                <div class="col-md-6 px-3">
                    ...
                    <a href="user/create" type="button" class="btn border-success btn-md bg-dark"><i class="fa fa-user text-success"></i> Be a Vaccination Provider</a>
...
<footer class="footer footer-nav bg-dark">
    <div class="container">
        <div class="row">

            <small class="">
            <img src="https://activepass.app/img/plus.png" style="height: 15px; width:15px">
