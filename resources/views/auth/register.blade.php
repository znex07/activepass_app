...
@section('content')
<form method="POST" action="{{ route('healthpartner.store') }}" id="provider-new">
    @csrf
<div id="health-reg">
@if ($errors->any())
...
<h3>Fill Up </h3>
    ...
    <div class="row">
        <div class="form-group col-md-4">
            <input type="text" class="form-control" name="tel" id="in_tel" placeholder="Telephone Number *" value="{{old('tel')}}">
        </div>
    </div>
    <div class="row">
        <div class="form-group col-md-4">
            <input type="text" class="form-control" name="cp" id="in_cp" placeholder="Cellphone Number *" value="{{old('cp')}}">
        </div>
    </div>
    <div class="row">
        <div class="form-group col-md-4">
            <input type="text" class="form-control" name="company_email" id="in_comp_email" placeholder="Company Email Address *" value="{{old('company_email')}}">
        </div>
    </div>
    </div>
    </div>
...
<h3>Representative</h3>
    ...
    <div class="card">
        ...
        <div class="row">
            <div class="form-group col-md-4">
                <input type="text" class="form-control" name="fname1" id="fname1" placeholder="First Name *" value="{{old('fname1')}}">
            </div>
            <div class="form-group col-md-4">
        ...
        <div class="row">
            <div class="form-group col-md-4">
                <input type="text" class="form-control" name="email" id="email1" placeholder="Email Address *" value="{{old('email')}}">
            </div>
        </div>
        <h2 for="exampleFormControlInput1" class="text-dark"><i class="fas fa-user"></i> Company Representative 2</h2>
        <div class="row">
            <div class="form-group col-md-4">
                <input type="text" class="form-control" name="fname2" id="fname2" value="{{old('fname2')}}" placeholder="First Name *">
            </div>
            <div class="form-group col-md-4">
        ...
        <div class="row">
            <div class="form-group col-md-4">
                <input type="text" class="form-control" name="email2" id="email2" value="{{old('email2')}}" placeholder="Email Address *">
            </div>
        </div>
        </div>
        </div>
